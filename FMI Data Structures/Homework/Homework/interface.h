...
struct Client {
	// The time at which client arrives
	int arriveMinute;
	// Amount of bananas the client wants to take
	int banana;
	// Amount of schweppes the client wants to take
	int schweppes;
	// The max amount of time the client will wait before he departs
	int maxWaitTime;
};
